...
wdpath <- 'C:/Users/David Hemphill/Documents/GEB_6895/Fork/GEB6895F19/demo_03_intro_to_R'
setwd(wdPath)
...
# The variables above are character strings. Class just states what the variable is, integer, number, etc
class(workspacePath)
...
# Adding numeric variables can change the type. anything before the <- is just the new name for the value you assign to it
